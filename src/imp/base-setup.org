...
- name: clonning systems-model repo from bitbucket
  git: repo="{{systems_model_repo}}" dest="{{systems_model_dest}}" version=cluster-automationxs
  environment: "{{proxy_env}}"
...
*** Handlers 
    Handlers comes into play when there is a notify statement in any of the task
    files.
