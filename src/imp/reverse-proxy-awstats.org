...
*** reverse-proxy 
**** =main=
#+BEGIN_SRC yml :tangle reverse-proxy-server/tasks/main.yml
...
**** =dependencies=
#+begin_src yml :tangle reverse-proxy-server/meta/main.yml
...
**** =ficfg-eth1=
#+BEGIN_SRC yml :tangle reverse-proxyserver/templates/ifcfg-eth1
