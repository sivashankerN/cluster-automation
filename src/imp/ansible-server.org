...
---
- name: Commenting rsnapshot_client  in public_dns.yml
  lineinfile: 
...
- name: Commenting ossec_client in public_dns.yml
  lineinfile: 
     path: systems-model/build/{{clustername}}/public_dns.yaml
     regexp: '^    - ossec_client'
     line: '    # - ossec_client'

- name: Commenting rsnapshot_client in private_dns.yml
  lineinfile: 
...
- name: Commenting ossec_client in private_dns.yml
  lineinfile: 
     path: systems-model/build/{{clustername}}/private_dns.yaml
     regexp: '^    - ossec_client'
     line: '    # - ossec_client'
...
---
- name: Commenting rsnapshot_client in router.yaml
  replace:
...
- name: Commenting ossec_client in router.yaml
  replace:
     path: systems-model/build/{{clustername}}/router.yaml
     regexp: '^    - ossec_client'
